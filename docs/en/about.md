...
The ZsiBot SDK provides secondary development support for the ZsiBot quadruped robot platform, facilitating users to quickly integrate motion control, status acquisition and other functions.
